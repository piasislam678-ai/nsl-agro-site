...
export default function HomePage() {
  return (
    <>
      ...
      {/* ✅ Floating Facebook Button with Icon */}
      <a
        href="https://www.facebook.com/profile.php?id=61575425881245"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white w-14 h-14 flex items-center justify-center rounded-full shadow-lg z-50 transition-all"
